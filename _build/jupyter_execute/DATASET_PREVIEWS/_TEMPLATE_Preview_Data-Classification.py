...
# # Template: Preview Classification Dataset
...
DROP_COLS = ['PassengerId','Ticket','Name',"Cabin"]#'id','date']
...
# # 📌 BOOKMARK: Update modeling below to classification
...
sf.evaluate_classification(logreg,X_test_df,y_test,  
                           X_train=X_train_df,y_train=y_train,
                           label='Logistic Regression - class_weight="balanced" - C=1e12')


# ## 📌 BOOKMARK: NEED CLASSIFICATION FUNCTIONS

# In[28]:


coeffs = sf.get_logreg_coefficients(logreg, X_train_df)
coeffs
